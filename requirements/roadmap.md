...
| Advisor Treatment Plan Contract Readiness | Integration | Align HiveSight and HiveSight Advisor on stable jurisdiction identifiers, response contract versioning, Advisor answer ids, and repeated unresolved request behaviour before enabling the real Advisor adapter outside smoke tests. |
